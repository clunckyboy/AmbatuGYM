...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet"
        href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=brightness_4" />
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .comment-form-section .btn-custom{
                width: 40%;
                text-align: center;
                margin-bottom: 20px;
            }
        ...
        .comments-section::-webkit-scrollbar-thumb:hover {
            background-color: rgba(97, 58, 42, 1);
...
<body>
    <nav class="navbar">
        <img src="./images/ambatugymwhite.png" data-light="./images/ambatugymwhite.png"
            data-dark="./images/ambatugym2.png" alt="ambatuLOGO">
        ...
        <div class="container">
            ...
            <div class="comment-form-section">
                ...
                <form action="./logic/comment.php" method="POST" autocomplete="off">
                    <textarea id="commentInput" name="comment" class="form" placeholder="Say something!" rows="10"
                        cols="50" maxlength="700" required></textarea>
